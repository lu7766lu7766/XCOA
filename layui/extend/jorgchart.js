    ...
    if (opts.pan) {
      ...
      $chart.on('mousedown',function(e){
        ...
        $(document).on('mousemove',function(ev) {
          ...
          // if(newX<=16&&newX>=($chartContainer.width() - $chart.width() - 50)){
          //     newX=newX;
          // }else if(newX>=16){
          //     newX=16
          // }else if(newX<=($chartContainer.width() - $chart.width() - 50)){
          //   newX=($chartContainer.width() - $chart.width() - 50)
          // }
          // if(newY<=16&&newY>=($chartContainer.height() - $chart.height() - 50)){
          //     newY=newY;
          // }else if(newY>=16){
          //     newY=16
          // }else if(newY<=($chartContainer.height() - $chart.height() - 50)){
          //   newY=($chartContainer.height() - $chart.height() - 50)
          // }
          // if($chartContainer.width() > $chart.width()){
          //   newX=0
          // }
          // if($chartContainer.height() > $chart.height()){
          //   newY=0
          // }
