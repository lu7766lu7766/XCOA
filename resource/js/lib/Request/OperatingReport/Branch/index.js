...
export default class Request extends BaseRequest {
	get baseUrls() {
		return super.baseUrls.concat('api/branch/operating_report')
	}
	...
	async getHeadquarters(data, options) {
		return await this.request('headquarters', data, options)
	}

	async getHeadquartersPayout(data, options) {
		return await this.request('headquartersPayout', data, options)
	}
}
