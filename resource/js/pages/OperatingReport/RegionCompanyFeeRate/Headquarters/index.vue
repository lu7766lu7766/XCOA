      ...
      <div class="layui-row layui-col-space10 layui-card-body">
        ...
        >
          <thead>
            <tr>
              <th class="toggle-btn">
                <span class="btn-plus" @click="toggleAll">
                  <i class="fa fa-plus"></i> {{ txt.switch }}
                </span>
          ...
          >
            ...
            >
              ...
              <template v-for="company in showCompany">
                <template
                  v-for="totalFee in [
                    getSumByListFilter(baoxiaoDatas, [company.id], 'company_id')
                  ]"
                >
                  <td class="text-right">
                    <router-link
            ...
            >
              ...
              <td class="text-right">
                {{
                  (_.jSumBy(feeDatas, "total_amount") /
                    _.jSumBy(baoxiaoDatas, "total_amount"))
                    | percent
                }}%
              </td>
              <td class="text-right">
                {{
                  (_.jSumBy(feeDatas, "total_amount") / allDatasTotalFee)
                    | percent
                }}%
              </td>
              <template v-for="company in showCompany">
                <template
                  v-for="totalFee in [
                    getSumByListFilter(feeDatas, [company.id], 'company_id')
                  ]"
                >
                  <td class="text-right">
                    <router-link
          ...
          <tfoot>
            <tr>
              ...
              <template v-for="company in showCompany">
                <td class="text-right">
                  {{
                    getSumByListFilter(datas, [company.id], "company_id")
                      | money
                  }}
                </td>
                <td></td>
