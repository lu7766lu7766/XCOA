							...
							<template v-for="company in showCompany">
								<template v-for="totalFee in [getSumByListFilter(baoxiaoDatas, [company.id], 'company_id')]">
									...
									<td class="text-right">
										...
										<span v-else>{{ (totalFee / totalFee) | percent }}%</span>
									</td>
									<td class="text-right">
										<router-link
											class="text-green"
										...
										>
											{{ (totalFee / getSumByListFilter(datas, [company.id], 'company_id')) | percent }}%
										</router-link>
										<span v-else>{{ (totalFee / getSumByListFilter(datas, [company.id], 'company_id')) | percent }}%</span>
									</td>
									<td class="text-right">
										<router-link
											class="text-green"
